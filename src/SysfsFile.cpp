...
SysfsFile::SysfsFile(const std::string& device,
   ...
   path(joinPath(getSubdevicePath(device, "board"), attribute)),
   errnoMap(errnoMap)
{
}
...
SysfsFile::SysfsFile(const std::string& device,
                     ...
                     const std::string& attribute,
                     const ErrnoMap&    errnoMap) :
   path(joinPath(getSubdevicePath(device, subdevice), attribute)),
   errnoMap(errnoMap)
{
}
...
bool SysfsFile::waitUntilExistence(const bool    exists,
...
PersonalitySysfsFile::PersonalitySysfsFile(const std::string& device,
                                           const std::string& attribute,
                                           const ErrnoMap&    errnoMap) :
   SysfsFile(baseSysfsPath, errnoMap)
{
